    ...
    <div class="tab-content">
        @foreach($templates as $key => $value)
            <div class="tab-pane @if($loop->index == 0) active @endif" id="cn_{{$key}}">
                ...
                @if($key == 'new_sale' || $key == 'payment_received' || $key == 'payment_reminder' || $key == 'new_booking' || $key == 'new_quotation' || $key == 'new_order' || $key == 'payment_paid' || $key == 'items_received' || $key == 'items_pending' || $key == 'purchase_order')
