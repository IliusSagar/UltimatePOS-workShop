  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <!-- // want to need discount input here -->
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("discount", @num_format($payment_line->discount ?? 0), ['class' => 'form-control input_number payment_discount', 'placeholder' => 'Discount']); !!}
            </div>
          </div>
        </div>
